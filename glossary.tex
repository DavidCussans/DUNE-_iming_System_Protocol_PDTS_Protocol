...
\newduneabbrev{group}{group}{Timing Group}{A collection of endpoints that all receive the same fixed length (synchronous) timing messages.}
...
\newduneabbrev{dts}{DTS}{Dune Timing System}{The timing and synchronization system for DUNE. An umbrella term encompassing both the \single and \dual detector module timing systems}

\newduneabbrev{spts}{SPTS}{Single Phase Timing System}{A timing and synchronization system deployed at ProtoDUNE SP I. It distributes a clock and synchronization signals, but places considerably less burden on the end-points.}
